        ...
        <div className="p-6 space-y-8">
          ...
          <div className="text-center space-y-4 py-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Conecte-se com seus eleitores através de campanhas inteligentes e automações personalizadas
            </p>
          </div>
              ...
              <CardContent className="space-y-4 flex-1 flex flex-col">
                <div className="space-y-2 text-sm text-muted-foreground flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>Cores e blocos personalizáveis</span>
                  </div>
                  <div className="flex items-center gap-2">
          ...
          <div className="text-center py-8 px-6 bg-gradient-to-r from-primary/5 to-primary/10 rounded-2xl">
            ...
            <p className="text-muted-foreground mb-4">
              Estamos trabalhando para trazer ainda mais ferramentas de marketing digital para o seu gabinete
            </p>

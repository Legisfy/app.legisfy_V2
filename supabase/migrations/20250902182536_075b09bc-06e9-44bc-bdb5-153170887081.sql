-- Fix: ensure extension functions are resolvable inside SECURITY DEFINER by including 'extensions' in search_path
...
BEGIN
  ...
  -- Generate new token and expiration using pgcrypto in extensions schema

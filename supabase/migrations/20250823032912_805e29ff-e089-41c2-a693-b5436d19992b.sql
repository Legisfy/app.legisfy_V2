-- Fix enum creation and recreate indication tags
...
-- MEIO AMBIENTE (Green theme - different shades)
INSERT INTO public.indication_tags (name, category, icon, color, tag_type) VALUES
...
-- Update the indicacoes table to include tag reference and responsavel_nome

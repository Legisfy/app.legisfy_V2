-- Remover função antiga e criar nova versão que trabalha com camaras
DROP FUNCTION IF EXISTS public.send_principal_invite(uuid, text);

-- Criar nova função que trabalha com camara_id em vez de institution_id  
...
BEGIN
  ...
  -- Check for existing active invitation using camara_id as institution_id

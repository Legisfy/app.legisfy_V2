-- Fix infinite recursion in gabinetes RLS policy first
...
-- Fix storage for logo uploads - delete objects first, then bucket
DELETE FROM storage.objects WHERE bucket_id = 'gabinete-logos';

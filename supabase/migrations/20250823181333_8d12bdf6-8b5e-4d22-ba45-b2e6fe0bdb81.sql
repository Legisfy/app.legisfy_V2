...
CREATE POLICY IF NOT EXISTS "members_select_indicacao_status_events"
...
CREATE POLICY IF NOT EXISTS "members_insert_indicacao_status_events"
ON public.indicacao_status_events
FOR INSERT
WITH CHECK (
...
-- No UPDATE/DELETE by default to keep events immutable

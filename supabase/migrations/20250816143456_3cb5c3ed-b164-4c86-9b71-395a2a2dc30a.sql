-- ==============================
-- MIGRAÇÃO PARA ALINHAR ESTRUTURA LEGISFY
-- ==============================
...
-- ==============================
-- 3. TABELA INSTITUTIONS (mapeando camaras existentes)
-- ==============================
...
-- Migrar dados de camaras para institutions
INSERT INTO public.institutions (id, name, city_id, endereco, telefone, email, presidente, logomarca_url, created_at, updated_at)
SELECT 
    cam.id,
    cam.nome,
    cit.id as city_id,
...
-- ==============================
-- 11. ADICIONAR CABINET_ID ÀS TABELAS EXISTENTES
-- ==============================

-- Atualizar eleitores para usar cabinet_id consistente
